...
def date_picker_trigger(value=None, open_status=False, key=None):
...
def date_picker(label=None, value=None, min_value=None, max_value=None, key=None):
    ...
    with stylable_container(key="all", css_styles="""
        ...
        trigger_pos = date_picker_trigger(value=value, open_status=open_status, key=trigger_component_key)
